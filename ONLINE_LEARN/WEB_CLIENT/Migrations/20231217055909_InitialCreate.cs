        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudentID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChosenAnwser = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Start_Quiz", x => x.StartID);
                    table.ForeignKey(
                        name: "FK_Start_Quiz_Quiz_QuestionID",
                        column: x => x.QuestionID,
                        principalTable: "Quiz",
                        principalColumn: "QuestionID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Start_Quiz_User_StudentID",
                        column: x => x.StudentID,
                        principalTable: "User",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Start_Quiz_QuestionID",
                table: "Start_Quiz",
                column: "QuestionID");

            migrationBuilder.CreateIndex(
                name: "IX_Start_Quiz_StudentID",
                table: "Start_Quiz",
                column: "StudentID");
        }
